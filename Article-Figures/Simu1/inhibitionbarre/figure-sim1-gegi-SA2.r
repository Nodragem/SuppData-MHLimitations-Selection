...
## work on SA2
MH_folder <- paste0(main_folder, "/cste-10-3-10-sx50-sy50-k2.0-inh[1.42484]/")

print(paste("Working on:", MH_folder))
sizes_plotted <- c(2, 28, 42)
...
pdf("figure-sim1-gegi-SA2.pdf", width = 7.0, height=7.0/1.8, pointsize = 1/300)
